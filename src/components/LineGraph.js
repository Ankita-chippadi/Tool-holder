  ...
  return (
    ...
    >
      ...
      <input
        ...
        style={{position:'relative', left:'70%',width:'150px',height:'40px',bottom:'150px' }}
      />
     
     <button
  onClick={toggleAveraging}
  className={`border border-black text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-black` }
  style={{ background: averagingEnabled ? 'green' : 'gray', position:'relative', left:'79%',width:'150px',height:'40px',bottom:'150px' }}
>
  {averagingEnabled ? 'Averaging Off' : 'Averaging On'}
</button>
      
       <select value={calculationType} onChange={(e) => setCalculationType(e.target.value)} style={{position:'relative', left:'65%',width:'150px',height:'40px',bottom:'150px' }}
       className={`border border-black text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-black` }>
      ...
      {/* <DeleteFilePopup onDelete={handleDeleteFile}  /> */}
      <ViewBoundsToggle 
        chartRef={chartRef} 
        ...
        // minXData={minXData} // Pass minXData as a prop
        // maxXData={maxXData} // Pass maxXData as a prop
        chartData={chartData} 
      />
